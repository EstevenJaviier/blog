...
class ArticlesController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        alert()->success('Vaya', 'El Articulo ' . $article->title . ' a sido borrado de forma exitosa');

        Flash::warning('El Articulo ' . $article->title . ' a sido editado de forma exitosa¡');
        return redirect()->route('admin.articles.index');
    }
    ...
    public function destroy($id)
    {
        ...
        alert()->info('Vaya', 'El Articulo ' . $article->name . ' a sido borrado de forma exitosa');
